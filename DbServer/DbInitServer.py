...
class DbInitServer:
    def __init__(self):
        ...
        self.userMsg = Cs.returnUserMsgPath()
    ...
    def initDb(self, ):
        ...
        # 初始化用户消息
        userMsgConn, userMsgCursor = Dds.openDb(self.userMsg)
        self.createTable(userMsgCursor, 'userMsg', 'wxId varchar(255), roomId varchar(255), question text, answer text,createTime integer')
        Dds.closeDb(userMsgConn, userMsgCursor)
